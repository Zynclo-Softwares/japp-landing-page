...
const faqs = [
  ...
  },
  {
    ...
    a: 'You provide any HTML/CSS/Tailwind resume layout — your own design, a template you bought, or one you built yourself. Just Apply fills it with tailored, polished content every time. Your visual identity, our words.',
  },
  {
  ...
  },
  {
    ...
    a: 'GPT-5, Claude Opus 4.7, Gemini 2.5, Llama 3.3, and local Ollama for full privacy. Pro subscribers can switch models per generation. The model picker is per-run, not a global setting.',
  },
  {
  ...
  },
  {
    ...
    a: 'Your profile and application data stay local by default. When you use cloud models (GPT-5, Claude, etc.), your prompts go through those providers\' APIs. For full privacy, use local Ollama — no data leaves your machine.',
  },
  {
