...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden flex flex-col justify-start pt-10 pb-16 lg:justify-center lg:py-32 lg:min-h-[calc(100vh-64px)]" id="how-it-works">
      {/* Amber mesh blobs */}
